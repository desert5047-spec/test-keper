...
const styles = StyleSheet.create({
  ...
  word: { fontWeight: '800' },
  input: { borderWidth: 1, borderColor: '#ddd', borderRadius: 12, paddingHorizontal: 12, paddingVertical: 10, fontSize: 16, marginBottom: 12, color: '#333' },
  ...
  btnGhostText: { fontWeight: '700', color: '#333' },
